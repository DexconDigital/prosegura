  ...
  for ($i = 0; $i < $cantidad_inmuebles; $i++) {
    ...
    echo '
            ...
            <div class="card mt-4" style="">
              ...
              <div class=" row col-12 margen_targeta">
                <div class="col-12">
  ...
  for ($i = 0; $i < count($r); $i++) {
    ...
    echo '
                ...
                <div class="property-list">
                    <div class="row d-flex justify-content-around m-auto margen_contenedor_card">
    ...
    echo '
                            ...
                            <div class="col-12">
                                <ul id="list" class="row contenedor_icon margen_lista_card">
                                    ...
                                    <li class="col-12 col-md-auto ml-auto color_black border text-center mt-5"><a class=" color_blanco rounded-0 btn col-12" href="detalle_inmueble.php?co='.$codigo.'">Ver más</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
